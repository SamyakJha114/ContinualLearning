...
def main():
    ...
    if args.model == 'CAT':
        model = CAT(args.embed_size, args.heads, args.num_layers, args.num_experts, vocab_size, args.max_length)
    else:
        model = GPTDeMIX(args.embed_size, args.heads, args.num_layers, args.num_experts, vocab_size, args.max_length)
